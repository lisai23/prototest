...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::t::test, _impl_.id_),
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::t::_test_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 43, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
test::test(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:t.test)
}
...
template<> PROTOBUF_NOINLINE ::t::test*
Arena::CreateMaybeMessage< ::t::test >(Arena* arena) {
  return Arena::CreateMessageInternal< ::t::test >(arena);
}
